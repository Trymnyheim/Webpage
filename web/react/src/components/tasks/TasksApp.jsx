...
function TasksApp() {
    ...
    const [currentList, setCurrentList] = useState(taskLists[0]);
    ...
    function testData() {
        return [
            ...
            {   id: "2",
                title: "List Nr. 2",
                tasks: [
                    {id: 1, title: "In list nr 2", desc: "Dette er den første testtasken. Vi får se hvordan dette går da!", date: "21.10.97", comp: 1},
                    {id: 2, title: "Test2", desc: "Andre test", date: "31.10.97", comp: 0}
                ]
            }
        ]
    ...
    return (
        <>
            ...
            {currentList && <TaskList taskList={currentList} />}
        </>
    )
}
